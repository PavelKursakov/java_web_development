...
public class Constants {
    ...
    public static final String CSV_NAME = "src/results11.csv";
    ...
    public static final String SELECT_MEAN_VALUE_OF_MARKS = "SELECT distinct logins.name as login," +
    ...
    public static final String FIVE_FOR_EQUALS = "5";
